...
class RegistrationPage extends StatelessWidget {
  final SignInController registrationController = Get.put(SignInController());
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Container(
            ...
            child: Obx(() {
              if (registrationController.googleAccunt.value == null) {
  ...
  ListView signInPage(
      GlobalKey<FormBuilderState> _formKey, BuildContext context) {
    return ListView(
      children: [
        SizedBox(
          height: 30,
